...
import { addComment as Mutation$addComment } from "../schema/comment.js";
import {
...
import {
  commentAdded as Subscription$commentAdded,
  postCreated as Subscription$postCreated,
...
export function createResolvers({
  ...
  return {
    ...
    Subscription: {
      commentAdded: {
        subscribe: Subscription$commentAdded,
