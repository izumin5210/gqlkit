...
import type { AutoGeneratedType } from "./auto-generated-type.js";
...
interface FindUserDefinedCollisionsParams {
  readonly userDefinedTypes: ReadonlyArray<UserDefinedTypeInfo>;
  readonly autoGeneratedTypes: ReadonlyArray<AutoGeneratedType>;
  readonly sourceRoot: string | null;
}
...
function findUserDefinedCollisions(
  params: FindUserDefinedCollisionsParams,
): Diagnostic[] {
  const { userDefinedTypes, autoGeneratedTypes, sourceRoot } = params;
...
export function validateNameCollisions(
  ...
  const userCollisions = findUserDefinedCollisions({
    userDefinedTypes: input.userDefinedTypes,
    autoGeneratedTypes: input.autoGeneratedTypes,
